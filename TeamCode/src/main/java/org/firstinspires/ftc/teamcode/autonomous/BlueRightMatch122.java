...
@Autonomous(name="BlueRightMatch122", group="FSMAuto", preselectTeleOp="teleOp")
public class
BlueRightMatch122 extends LinearOpMode {
    ...
    BlueRightMatch122.State currentState = BlueRightMatch122.State.IDLE;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        currentState = BlueRightMatch122.State.State1;
        for (LynxModule hub : allHubs) {
            hub.clearBulkCache();
        }
                ...
                case State9:
                    if (!drive.isBusy()) {
                        ...
                        TrajectorySequence BackboardPixel4 = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                .addTemporalMarker(0.8, () -> claw.setRotateAngle("intake", 0.0))
                                .addTemporalMarker(0.8, () -> lift.setTargetHeight(0, 0))
                                .addTemporalMarker(1.2, () -> {
                                    claw.setDeliverArm("intake");
                                    armIn = true;
                                })
                                .waitSeconds(0.5) //was 0.4
