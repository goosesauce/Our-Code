...
@Autonomous(name="BlueLeftBack2plus4", group="FSMAuto", preselectTeleOp="teleOp")
public class BlueLeftBack2plus4 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        currentState = BlueLeftBack2plus4.State.SpikeDelivery;
        boolean set = false;
            ...
            switch (currentState) {
                case SpikeDelivery: //.splineTo(new Vector2d(52, -27.5), Math.toRadians(0))
                    if (position == 1) {
                        TrajectorySequence LeftPos = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                .lineToLinearHeading(new Pose2d(34, 35.5, Math.toRadians(-180))) //35.5
                        ...
                        TrajectorySequence MiddlePos = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                .splineTo(new Vector2d(28, 34.5), Math.toRadians(0))
                                //.lineToLinearHeading(new Pose2d(28, 40, Math.toRadians(-225)))
                                .lineToLinearHeading(new Pose2d(28, 26.25, Math.toRadians(-180)))
                                .build(); //-21, -60
                        ...
                        TrajectorySequence RightPos = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                .lineToLinearHeading(new Pose2d(13.25, 36.5, Math.toRadians(-180))) //12.5
                                .build(); //-21, -60
                        if (!drive.isBusy()) {
                            currentState = State.BackboardPixel0;
                ...
                case BackboardPixel0:
                    if (position == 1) {
                        TrajectorySequence LeftPosBackboard = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                .splineToConstantHeading(new Vector2d(54, 43), Math.toRadians(0)). //42.5
                                build(); //-21, -60
                        if (!drive.isBusy()) {
                        ...
                        TrajectorySequence MiddlePosBackboard = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                //.waitSeconds(0.3)
                                .addTemporalMarker(0.5, () -> intake.horiPower(0.0))
                                .splineTo(new Vector2d(54, 37), Math.toRadians(0))
                                .build(); //-21, -60
                        if (!drive.isBusy()) {
                            currentState = State.BackboardPixel1;
                        ...
                        TrajectorySequence RightPosBackboard = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                //.waitSeconds(0.3)
                                .addTemporalMarker(0.5, () -> intake.horiPower(0.0))
                                .splineTo(new Vector2d(55, 31), Math.toRadians(0))//was28.5
                                .build(); //-21, -60*/
                        if (!drive.isBusy()) {
                            currentState = State.BackboardPixel1;
                ...
                case BackboardPixel1:
                    TrajectorySequence LeftPosBackboarddepart = drive.trajectorySequenceBuilder(poseEstimate)
                            ...
                            .addTemporalMarker(3, () -> intake.horiPower(-0.70))
                            ...
                            .lineToLinearHeading(new Pose2d(-59.5, 41, Math.toRadians(195)))//.lineToLinearHeading(new Pose2d(-62.5, 40, Math.toRadians(195)))
                ...
                case BackboardPixel2:
                    if (!drive.isBusy()) {
                        ...
                        TrajectorySequence BackboardPixel2 = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                .lineToLinearHeading(new Pose2d(-35, 61.5, Math.toRadians(180))) //61
                                //.splineTo(new Vector2d(-40, 60), Math.toRadians(0))
                                .lineToConstantHeading(new Vector2d(12, 61.5)) //61
                                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                                    lift.setTargetHeight(850, 0); //800
                                })
                                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                                    claw.setDeliverArm("delivery");
                                    armIn = false;
                ...
                case PixelPickup2:
                    if (!drive.isBusy()) {
                        ...
                        TrajectorySequence PixelPickup2 = drive.trajectorySequenceBuilder(poseEstimate)
                                ...
                                .waitSeconds(0.2) //was 0.6
                                .splineTo(new Vector2d(24, 61), Math.toRadians(180)) //61
                                ...
                                .lineToLinearHeading(new Pose2d(-59.5, 42.5, Math.toRadians(190))) //-62.5, 40
                                //.lineToConstantHeading(new Vector2d(-62.5, -41),
                                  //      SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    //    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                                .build();
